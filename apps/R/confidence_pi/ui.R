...
dashboardPage(
  ...
  dashboardBody(
    fluidRow(
      column(width = 12, 
             box(title=gettext("Confidence intervals for the proportion"), status="primary",
...
#            fluidRow(column(4, div(class = "brand pull-left", gettext("Confidence intervals for the proportion"))),
